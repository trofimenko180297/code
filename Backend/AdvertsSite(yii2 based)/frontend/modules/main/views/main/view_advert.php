<div class="row">
    ...
    <div class="col-lg-9 col-sm-8 ">
        ...
        <h2><?=frontend\components\Common::getTittle($model)?></h2>
        <div class="row">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                ...
                <div class="col-lg-12 col-sm-6 ">
                    <div class="enquiry">
                        <h6><span class="glyphicon glyphicon-envelope"></span>Message to user</h6>
                        <?php
                        $form = \yii\bootstrap\ActiveForm::begin();
                        ?>
                        <?=$form->field($model_feedback,'email')->textInput(['value' => $current_user['email'], 'placeholder' => 'Your email'])->label(false) ?>
                        <?=$form->field($model_feedback,'name')->textInput(['value' => $current_user['username'], 'placeholder' => 'Your name'])->label(false) ?>
